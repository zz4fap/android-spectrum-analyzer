...
public class SpectrumAnalyzer extends Activity implements
        Button.OnClickListener, AudioProcessingListener {
    ...
    private void setSpectrumAnalyzer() {
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(
                this, R.array.frequencies_array,
                android.R.layout.simple_spinner_item);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        fs_spinner.setAdapter(adapter);
        fs_spinner
                .setOnItemSelectedListener(new OnSamplingRateItemSelectedListener());
        ...
        adapter = ArrayAdapter.createFromResource(this,
                R.array.fft_points_array, android.R.layout.simple_spinner_item);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        fft_spinner.setAdapter(adapter);
        fft_spinner
                .setOnItemSelectedListener(new OnNumberOfFFTPointsItemSelectedListener());
        ...
        spectrum_display.getHolder();
    }

    public class OnSamplingRateItemSelectedListener implements
    ...
    public class OnNumberOfFFTPointsItemSelectedListener implements
            OnItemSelectedListener {
    ...
    private void onNumberOfFFTPointsChanged(int numberOfFFTPoints) {
        if (numberOfFFTPoints != mNumberOfFFTPoints) {
            ...
            mAudioCapture.close();
            mAudioCapture = new AudioProcessing(mSampleRateInHz,
                    mNumberOfFFTPoints);
        }
    }
    ...
    public void onDrawableFFTSignalAvailable(final double[] absSignal) {
        SpectrumAnalyzer.this.runOnUiThread(new Runnable() {
            public void run() {
                spectrum_display.drawSpectrum(absSignal, mSampleRateInHz,
                        mNumberOfFFTPoints, mAudioCapture.getMaxFFTSample());
                peak_freq_text_view.setText(Double.toString(mAudioCapture
                        .getPeakFrequency()));
            }
        });
    }
